...
class MLA3DVGConfig(PretrainedConfig):
    r"""
    This is the cocnfiguration class to store the configuration of a [`MLA3DVG`]. It is used to instantiate
    a MLA3DVGConfig model according to the specified arguments, defining the model architecture. 
