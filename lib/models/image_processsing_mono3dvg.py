...
class Mono3DVGImageProcessor(BaseImageProcessor):
    ...
    def post_process_3d_object_detection(
        ...
        """
        Convert the raw output of [`Mono3DVGForSingleObjectDetection`] into final 3D bounding boxes in (center_x, center_y, center_z, height, width, length) format.
        
        Args:
            outputs (`[Mono3DVGForSingleObjectDetectionOutput]`):
