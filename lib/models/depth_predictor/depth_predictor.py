...
class DepthPredictor(nn.Module):
    ...
    def forward(self, feature, mask, pos,space_embeds,space_maps):
        ...
        B, C, H, W = src.shape
        src =space_embeds.flatten(2).permute(2, 0, 1)
        mask = mask.flatten(1)
        ...
        depth_pos_embed_ip = self.interpolate_depth_embed(space_maps)
