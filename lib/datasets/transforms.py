    ...
    def apply(
        ...
        **params: Any,
        ...
        if random.randint(2):
            ...
            ch_arr= np.random.shuffle(ch_arr)
...
class Affine(CustomDualTransform):
    ...
    class InitSchema(BaseTransformInitSchema):
        scale: Union[ScaleFloatType, Dict[str, Any], None] = Field(
            default=None,
            description="Scaling factor or dictionary for independent axis scaling.",
        )
        shift: Union[ScaleFloatType, Dict[str, Any], None] = Field(
            default=None,
            description="Translation factor or dictionary for independent axis translation.",
        )
    def __init__(
    self,
    scale: Union[ScaleFloatType, Dict[str, Any], None] = None,
    shift: Union[ScaleFloatType, Dict[str, Any], None] = None,
